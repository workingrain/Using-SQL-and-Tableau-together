...
CREATE TABLE public.leading_causes
(
    year integer,
    "113cause" character varying(255),
    cause character varying(255),
    state character varying(255),
    deaths integer,
    age_adjusted numeric,
    state_initials character varying(2),
...
ALTER TABLE public.leading_causes
    ADD FOREIGN KEY (state_initials)
    REFERENCES public.location (state)
    NOT VALID;
